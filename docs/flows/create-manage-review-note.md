...
6. Clicking a sidebar note emits a one-shot navigation request. The canvas consumes it before opening or raising the document preview and centers/highlights the anchored range; later graph rerenders cannot replay it.
