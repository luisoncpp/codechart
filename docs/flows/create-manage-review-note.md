...
4. Done inline or Resolve in the sidebar removes a note immediately. Resolve all removes every note in the current sidebar filter as one mutation. One five-second Undo restores the latest single note or batch at its original array positions; a later resolution replaces the prior Undo opportunity.
