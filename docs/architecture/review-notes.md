...
Badge projection depends on the Review Notes document snapshot as well as the graph projection. Creating, resolving, undoing, or loading notes must refresh counts immediately without waiting for a semantic-zoom or layout change.
