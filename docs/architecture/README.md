...
| [unreal-config.md](./unreal-config.md) | `unreal_config` + C++ include-root resolution + config modal | Project-local C++ include paths, generated-file hiding, Unreal engine exclusion |
